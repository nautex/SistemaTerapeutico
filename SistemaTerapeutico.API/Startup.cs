...
namespace SistemaTerapeutico.BackEnd.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddTransient<IFilialViewRepository, FilialViewRepository>();
            //services.AddTransient<ISalonViewRepository, SalonViewRepository>();
            //services.AddTransient<IConceptoCobroViewRepository, ConceptoCobroViewRepository>();
            ...
            //services.AddTransient<IConceptoCobroRepository, ConceptoCobroRepository>();
            ...
            services.AddTransient<PersonaVinculacionService>();
            services.AddTransient<PersonaDocumentoService>();
            services.AddTransient<DireccionService>();
            services.AddTransient<AtencionService>();
            services.AddTransient<TerapiaService>();
            services.AddTransient<TerapiaPlanService>();
            services.AddTransient<PeriodoService>();
            services.AddTransient<SesionService>();
            services.AddTransient<UsuarioService>();
            services.AddTransient<UbigeoViewService>();
            services.AddTransient<CatalogoService>();
            services.AddTransient<FilialService>();
            services.AddTransient<SalonService>();
            services.AddTransient<ServicioService>();
            services.AddTransient<ModeloService>();
            services.AddTransient<PuntuacionService>();
            services.AddTransient<ComprobanteService>();
