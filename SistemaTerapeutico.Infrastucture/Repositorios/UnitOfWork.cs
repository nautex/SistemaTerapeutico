...
namespace SistemaTerapeutico.Infrastucture.Repositorios
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        //private readonly IParticipanteNivelLenguajeRepository _participanteNivelLenguajeRepository;
        private readonly IParticipanteNivelLenguajeViewRepository _participanteNivelLenguajeViewRepository;
        ...
        private readonly IFilialViewRepository _filialViewRepository;
        private readonly ISalonViewRepository _salonViewRepository;
        private readonly IConceptoCobroViewRepository _conceptoCobroViewRepository;
        private readonly IServicioRepository _servicioRepository;
        private readonly IPeriodoViewRepository _periodoViewRepository;
        private readonly IConceptoCobroRepository _conceptoCobroRepository;
        ...
        private readonly IAreaViewRepository _areaViewRepository;
        private readonly IDestrezaRepository _destrezaRepository;
        private readonly IAreaObjetivoRepository _areaObjetivoRepository;
        private readonly IAreaObjetivoViewRepository _areaObjetivoViewRepository;
        ...
        private readonly IAreaObjetivoCriterioResumenViewRepository _areaObjetivoCriterioResumenViewRepository;
        ...
        private readonly IComprobanteViewRepository _comprobanteViewRepository;
        //private readonly IComprobanteDetalleViewRepository _comprobanteDetalleViewRepository;
        //private readonly IComprobantePagoViewRepository _comprobantePagoViewRepository;
        private readonly IComprobanteResumenViewRepository _comprobanteResumenViewRepository;
        ...
        //public IFilialViewRepository FilialViewRepository => _filialViewRepository ?? new FilialViewRepository(_context);
        //public ISalonViewRepository SalonViewRepository => _salonViewRepository ?? new SalonViewRepository(_context);
        //public IConceptoCobroViewRepository ConceptoCobroViewRepository => _conceptoCobroViewRepository ?? new ConceptoCobroViewRepository(_context);
        ...
        //public IConceptoCobroRepository ConceptoCobroRepository => _conceptoCobroRepository ?? new ConceptoCobroRepository(_context);
        ...
        //public IParticipanteNivelLenguajeRepository ParticipanteNivelLenguajeRepository => _participanteNivelLenguajeRepository ?? new ParticipanteNivelLenguajeRepository(_context);
        //public IParticipanteNivelLenguajeViewRepository ParticipanteNivelLenguajeViewRepository => _participanteNivelLenguajeViewRepository ?? new ParticipanteNivelLenguajeViewRepository(_context);
        ...
        //public IAreaViewRepository AreaViewRepository => _areaViewRepository ?? new AreaViewRepository(_context);
        //public IDestrezaRepository DestrezaRepository => _destrezaRepository ?? new DestrezaRepository(_context);
        //public IAreaObjetivoRepository AreaObjetivoRepository => _areaObjetivoRepository ?? new AreaObjetivoRepository(_context);
        //public IAreaObjetivoViewRepository AreaObjetivoViewRepository => _areaObjetivoViewRepository ?? new AreaObjetivoViewRepository(_context);
        ...
        //public IAreaObjetivoCriterioResumenViewRepository AreaObjetivoCriterioResumenViewRepository => _areaObjetivoCriterioResumenViewRepository ?? new AreaObjetivoCriterioResumenViewRepository(_context);
        //public IComprobanteRepository ComprobanteRepository => _comprobanteRepository ?? new ComprobanteRepository(_context);
        //public IComprobanteDetalleRepository ComprobanteDetalleRepository => _comprobanteDetalleRepository ?? new ComprobanteDetalleRepository(_context);
        //public IComprobantePagoRepository ComprobantePagoRepository => _comprobantePagoRepository ?? new ComprobantePagoRepository(_context);
        //public IComprobanteViewRepository ComprobanteViewRepository => _comprobanteViewRepository ?? new ComprobanteViewRepository(_context);
        //public IComprobanteDetalleViewRepository ComprobanteDetalleViewRepository => _comprobanteDetalleViewRepository ?? new ComprobanteDetalleViewRepository(_context);
        //public IComprobantePagoViewRepository ComprobantePagoViewRepository => _comprobantePagoViewRepository ?? new ComprobantePagoViewRepository(_context);
        //public IComprobanteResumenViewRepository ComprobanteResumenViewRepository => _comprobanteResumenViewRepository ?? new ComprobanteResumenViewRepository(_context);
